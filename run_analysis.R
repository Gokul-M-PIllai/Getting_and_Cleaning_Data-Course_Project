...
SelectiveDScolnames <- gsub("Freq","Frequency", SelectiveDScolnames)
SelectiveDScolnames <- gsub("std","StandardDeviation", SelectiveDScolnames)

#replace the consecutive occurence of "Body" in description
SelectiveDScolnames <- gsub("[Bb]ody[Bb]ody","Body", SelectiveDScolnames)
