...
## Repository Contents
1.  README.md 
2.  CookBook.md : To indicate all the variables and summaries calculated, along with units, and any other relevant information.
3.  run_analysis.R : The R Script for creating Analysis and Creating the tidy data set.
4.  tidyData_ActivityTracker.txt : The file generated by code from the tidy data set created on R version 3.6.0 (2019-04-26).
